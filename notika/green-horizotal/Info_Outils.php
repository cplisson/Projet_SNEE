                        ...
                        <ul class="mobile-menu-nav">
                            <li><a data-toggle="collapse" data-target="#Charts" href="#">Home</a>
                                <ul class="collapse dropdown-header-top">
                                    ...
                                    <li><a href="Acceuil_CT.html">Acceuil CT</a></li>
                                    <li><a href="Reception.html">Je reçois</a></li>
                                    <li><a href="Recherche.html">Je recherche</a></li>
                                </ul>
                            </li>
                            <li><a data-toggle="collapse" data-target="#demoevent" href="#">Gestion outils</a>
                                <ul id="demoevent" class="collapse dropdown-header-top">
                                    <li><a href="M_habilitations.html">Mes habilitations</a></li>
                            ...
                            <li><a data-toggle="collapse" data-target="#democrou" href="#">Gestion employés</a>
                                <ul id="democrou" class="collapse dropdown-header-top">
                                    ...
                                    <li><a href="Gestion_E.html">Gestion employés</a></li>
                ...
                <div class="tab-content custom-menu-content">
                    <div id="Home" class="tab-pane in notika-tab-menu-bg animated flipInX">
                        <ul class="notika-main-menu-dropdown">
                            ...
                            <li><a href="Acceuil_CT.html">Acceuil CT</a>
                            </li>
                            <li><a href="Reception.html">Je reçois</a>
                            </li>
                            <li><a href="Recherche.html">Je recherche</a>
                            </li>
                        </ul>
                    </div>
                    <div id="mailbox" class="tab-pane active notika-tab-menu-bg animated flipInX">
                        <ul class="notika-main-menu-dropdown">
                            <li><a href="M_habilitations.html">Mes habilitations</a>
                            </li>
                    ...
                    <div id="Interface" class="tab-pane notika-tab-menu-bg animated flipInX">
                        <ul class="notika-main-menu-dropdown">
                            ...
                            <li><a href="Gestion_E.html">Gestion employés</a>
                            </li>
